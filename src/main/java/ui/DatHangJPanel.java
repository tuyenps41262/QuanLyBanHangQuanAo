...
public class DatHangJPanel extends javax.swing.JPanel {

    gioHangDAO ghdao;
    HoaDonDAO hoaDonDAO;
    public DatHangJPanel() {
        initComponents();
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThanhToanActionPerformed
        int confirm = JOptionPane.showConfirmDialog(DatHangJPanel.this, "Bạn xác nhận đặt hàng?");
